...
-- ── dim_customer ──────────────────────────────────────────────
ALTER VIEW `0-ai-trust`.gold.dim_customer
  SET TBLPROPERTIES (
...
-- ── dim_organisation ─────────────────────────────────────────
ALTER VIEW `0-ai-trust`.gold.dim_organisation
  SET TBLPROPERTIES (
...
-- ── dim_date ─────────────────────────────────────────────────
ALTER VIEW `0-ai-trust`.gold.dim_date
  SET TBLPROPERTIES (
...
ALTER VIEW `0-ai-trust`.gold.dim_stage_action_policy
  SET TBLPROPERTIES (
...
ALTER VIEW `0-ai-trust`.gold.fact_application_current
  SET TBLPROPERTIES (
...
ALTER VIEW `0-ai-trust`.gold.fact_application_document
  SET TBLPROPERTIES (
...
ALTER VIEW `0-ai-trust`.gold.fact_application_timeline_event
  SET TBLPROPERTIES (
...
ALTER VIEW `0-ai-trust`.gold.fact_subject_context_snapshot
  SET TBLPROPERTIES (
...
ALTER VIEW `0-ai-trust`.gold.bridge_organisation_party_role
  SET TBLPROPERTIES (
...
ALTER VIEW `0-ai-trust`.gold.bridge_organisation_relationship
  SET TBLPROPERTIES (
...
ALTER VIEW `0-ai-trust`.gold.bridge_application_party_authority
  SET TBLPROPERTIES (
...
ALTER VIEW `0-ai-trust`.gold.fact_verification_current
  SET TBLPROPERTIES (
...
ALTER VIEW `0-ai-trust`.gold.fact_service_case_current
  SET TBLPROPERTIES (
...
ALTER VIEW `0-ai-trust`.gold.fact_arrangement_current
  SET TBLPROPERTIES (
...
ALTER VIEW `0-ai-trust`.gold.fact_service_activity
  SET TBLPROPERTIES (
